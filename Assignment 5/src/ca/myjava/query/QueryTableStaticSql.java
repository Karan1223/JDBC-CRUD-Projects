...
public class QueryTableStaticSql 
{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		Countrystatic cs = new Countrystatic();
	}
}
class Countrystatic extends JFrame implements ActionListener
{
	...
	public Countrystatic() throws Exception
	{
	...
	public void viewData() throws ClassNotFoundException, SQLException 
	{
		...
		//Creating connection with database.
			...
			{
				//String query = from1;
				String query = "select * from country where lifeexpec BETWEEN '"+ from1 +"' AND '"+to1+"'";
		...
		}catch(Exception e)
		{
			...
			JOptionPane.showMessageDialog(null, "Data Dosen't Exsits.");
			 clearData();
		}
		conn.close();
	}
